...
def test_login(login_page_test):
...
def test_invalid_id_login(login_page_test):
    login_page_test.go_to_login_page()
...
def test_invalid_password_login(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("qa3team0202@elicer.com") 
...
def test_invalid_id_password_login(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("wrongtest@gmail.com")
    login_page_test.input_pw("validpass123!")
    login_page_test.click_login_button()
...
def test_null_id_login(login_page_test):
    login_page_test.go_to_login_page()
...
def test_null_password_login(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("qa3team0202@elicer.com")
...
def test_null_id_password_login(login_page_test):
    login_page_test.go_to_login_page()
...
def test_login_invalid_format(login_page_test):
    login_page_test.go_to_login_page()
...
def test_login_invalid_format2(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("qa3team0202@") 
    login_page_test.input_pw("team02fighting!") 
    login_page_test.click_login_button()
...
def test_pw_invalid_format(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("qa3team0202@elicer.com") 
...
def test_forgot_password(login_page_test):
    login_page_test.go_to_login_page()
...
def test_diff_account(login_page_test):
    login_page_test.go_to_login_page()
    login_page_test.input_id("qa3team0202@elicer.com")
    login_page_test.input_pw("team02fighting!")
    login_page_test.click_login_button()
...
def test_remove_history(login_page_test):
    login_page_test.go_to_login_page()
